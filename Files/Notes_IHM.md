...
Rivera trabalha com um projeto relacionado com fractais.
...
- Design de produto em hardware ou software:
...
- Habilidades e domínio de disciplinas
...
<!-- Imagem https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR04P40PRyKyQIk8OzgJcv92kAptR-MjYfz5g&usqp=CAU -->
...
<!-- Imagem Plano cartesiano de jogo -->
<!-- Imagem Ludificação da cultura -->
...
Custo de sequência de tarefas em uma atividade do usuário:
Custo = Soma (F(k)*C(k))
K: uma tarefa
...
<!-- Imagem: Table 1: Cognitive task analysis metrics and indicators -->
<!-- Imagem: Table 2: Visualization metrics and indicators -->
<!-- Imagem: Table 3: Fixation metrics and indicators -->
<!-- Imagem: Table 4: Saccade metrics and indicators -->
<!-- Imagem: Table 5: ... -->
...
- Atividades sempre acontecem em um contexto
...
- Framework> identifica tipos e causas de problemas de usabilidade na interação com tecnologias
...
<!-- Faltaram detalhes em cada um dos subtópicos -->
...
<!-- Imagem: Ecológico X Economia X Social -->
...
- Características inicialmente definidas
...
Usuário -> Ação -> Produto, sistema

<!-- Faltou descrição de cada um -->
...
- ISSO|IEC9126 (1991)
  ...
  - Atributos de software || Uso || Usuários <!-- Imagem -->
- ISSO|IEC25010 (2011)
  - > É a capacidade de um produto ser usado por usuários específicos para atingir objetivos específicos com eficácia, eficiência e em um contexto... <!-- Faltou pouco -->
